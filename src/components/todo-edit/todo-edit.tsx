...
function mapStateToProps(state: Store, ownProps: { itemId: number }) {
...
export const ToDoEdit = connect(mapStateToProps, mapDispatchToProps)(
    ({ item, itemId, itemSetText, goBack }: ToDoEditProps) => {
        if (!item) {
